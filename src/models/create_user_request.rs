...
pub struct CreateUserRequest {
	...
	/// Controls the status each email address is created with. Runs parallel to email_address: when provided, it must contain exactly one item per
	/// email address, applied by position. When omitted or empty, every email address is created verified. Set an item to reserved to create
	/// the corresponding email address reserved instead (unverified but usable for sign-in and locked so no other user can claim it).
	#[serde(rename = "email_address_identification_status", skip_serializing_if = "Option::is_none")]
	pub email_address_identification_status: Option<Vec<IdentificationStatus>>,
	...
	/// Controls the status each phone number is created with. Runs parallel to phone_number: when provided, it must contain exactly one item per
	/// phone number, applied by position. When omitted or empty, every phone number is created verified. Set an item to reserved to create
	/// the corresponding phone number reserved instead (unverified but usable for sign-in and locked so no other user can claim it).
	#[serde(rename = "phone_number_identification_status", skip_serializing_if = "Option::is_none")]
	pub phone_number_identification_status: Option<Vec<IdentificationStatus>>,
