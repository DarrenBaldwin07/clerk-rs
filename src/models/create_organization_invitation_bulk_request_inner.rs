...
impl CreateOrganizationInvitationBulkRequestInner {
	pub fn new(email_address: String, inviter_user_id: String, role: String) -> Result<CreateOrganizationInvitationBulkRequestInner, &'static str> {
		...
		Ok(CreateOrganizationInvitationBulkRequestInner {
			email_address,
			inviter_user_id,
			role,
	...
	pub fn new_unchecked(email_address: String, inviter_user_id: String, role: String) -> CreateOrganizationInvitationBulkRequestInner {
