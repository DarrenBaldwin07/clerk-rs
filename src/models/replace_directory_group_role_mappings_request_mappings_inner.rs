...
pub struct ReplaceDirectoryGroupRoleMappingsRequestMappingsInner {
...
impl ReplaceDirectoryGroupRoleMappingsRequestMappingsInner {
	pub fn new(role_id: String) -> ReplaceDirectoryGroupRoleMappingsRequestMappingsInner {
