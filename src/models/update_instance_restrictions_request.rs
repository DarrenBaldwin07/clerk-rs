...
pub struct UpdateInstanceRestrictionsRequest {
    ...
    #[serde(rename = "block_email_subaddresses", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub block_email_subaddresses: Option<Option<bool>>,
    #[serde(rename = "block_disposable_email_domains", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
