...
pub struct UpdateInstanceOrganizationSettingsRequest {
    ...
    #[serde(rename = "admin_delete_enabled", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub admin_delete_enabled: Option<Option<bool>>,
    #[serde(rename = "domains_enabled", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
