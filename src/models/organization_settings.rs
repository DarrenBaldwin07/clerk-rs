...
impl OrganizationSettings {
    pub fn new(object: Object, enabled: bool, max_allowed_memberships: i32, creator_role: String, admin_delete_enabled: bool, domains_enabled: bool, domains_enrollment_modes: Vec<DomainsEnrollmentModes>, domains_default_role: String) -> OrganizationSettings {
