...
impl OAuthApplicationWithSecret {
    pub fn new(object: Object, id: String, instance_id: String, name: String, client_id: String, public: bool, scopes: String, callback_url: String, authorize_url: String, token_fetch_url: String, user_info_url: String, created_at: i64, updated_at: i64) -> OAuthApplicationWithSecret {
