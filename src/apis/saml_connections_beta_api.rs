...
pub async fn create_saml_connection(configuration: &configuration::Configuration, create_saml_connection_request: Option<crate::models::CreateSamlConnectionRequest>) -> Result<crate::models::SamlConnection, Error<CreateSamlConnectionError>> {
...
pub async fn delete_saml_connection(configuration: &configuration::Configuration, saml_connection_id: &str) -> Result<crate::models::DeletedObject, Error<DeleteSamlConnectionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/saml_connections/{saml_connection_id}", local_var_configuration.base_path, saml_connection_id=crate::apis::urlencode(saml_connection_id));
...
pub async fn get_saml_connection(configuration: &configuration::Configuration, saml_connection_id: &str) -> Result<crate::models::SamlConnection, Error<GetSamlConnectionError>> {
    let local_var_configuration = configuration;
...
pub async fn list_saml_connections(configuration: &configuration::Configuration, limit: Option<f32>, offset: Option<f32>) -> Result<crate::models::SamlConnections, Error<ListSamlConnectionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_saml_connection(configuration: &configuration::Configuration, saml_connection_id: &str, update_saml_connection_request: crate::models::UpdateSamlConnectionRequest) -> Result<crate::models::SamlConnection, Error<UpdateSamlConnectionError>> {
    let local_var_configuration = configuration;
