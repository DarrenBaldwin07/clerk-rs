...
use super::Error;
use crate::{apis::ResponseContent, clerk::Clerk, util};
...
impl SignInToken {
	...
	pub async fn revoke_sign_in_token(
		...
		// Validate the sign_in_token_id before proceeding
		if let Err(validation_error) = crate::util::validate_token_id(sign_in_token_id) {
			// Convert the validation error to an appropriate API error
			return Err(Error::ResponseError(ResponseContent {
				status: reqwest::StatusCode::BAD_REQUEST,
				content: validation_error.to_string(),
				entity: Some(RevokeSignInTokenError::Status400(crate::models::ClerkErrors {
					errors: vec![crate::models::ClerkError {
						code: "invalid_input".to_string(),
						long_message: Some(validation_error.to_string()),
