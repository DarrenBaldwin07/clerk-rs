...
pub async fn update_instance_auth_config(clerk_configuration: &configuration::ClerkConfiguration, update_instance_auth_config_request: Option<crate::models::UpdateInstanceAuthConfigRequest>) -> Result<crate::models::UpdateInstanceAuthConfig200Response, Error<UpdateInstanceAuthConfigError>> {
...
pub async fn update_production_instance_domain(clerk_configuration: &configuration::ClerkConfiguration, update_production_instance_domain_request: Option<crate::models::UpdateProductionInstanceDomainRequest>) -> Result<(), Error<UpdateProductionInstanceDomainError>> {
    let local_var_configuration = clerk_configuration;
