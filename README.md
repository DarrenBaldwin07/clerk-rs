...
A comprehensive Rust SDK for interacting with the Clerk authentication API, offering seamless integration with popular Rust web frameworks including Actix, Axum, Rocket, and Poem.
...
- Framework-specific middleware for Actix, Axum, Rocket, and Poem
...
Enable the features for your specific web framework:
...
async fn main() -> Result<(), std::io::Error> {
    ...
    let clerk_poem_middleware = ClerkPoemMiddleware::new(
        ...
        true,
        // If you're using poem-openapi, you may need this to exclude some routes from auth verification
...
Check out the `/examples` directory for additional usage examples.
