...
pub async fn revoke_invitation(configuration: &configuration::Configuration, invitation_id: &str) -> Result<crate::models::RevokeInvitation200Response, Error<RevokeInvitationError>> {
    let local_var_configuration = configuration;
