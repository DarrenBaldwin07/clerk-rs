...
pub async fn create_allowlist_identifier(configuration: &configuration::Configuration, create_allowlist_identifier_request: Option<crate::models::CreateAllowlistIdentifierRequest>) -> Result<crate::models::AllowlistIdentifier, Error<CreateAllowlistIdentifierError>> {
...
pub async fn create_blocklist_identifier(configuration: &configuration::Configuration, create_blocklist_identifier_request: Option<crate::models::CreateBlocklistIdentifierRequest>) -> Result<crate::models::BlocklistIdentifier, Error<CreateBlocklistIdentifierError>> {
    let local_var_configuration = configuration;
