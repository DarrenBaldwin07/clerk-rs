...
pub async fn change_production_instance_domain(configuration: &configuration::Configuration, update_production_instance_domain_request: Option<crate::models::UpdateProductionInstanceDomainRequest>) -> Result<(), Error<ChangeProductionInstanceDomainError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/instance/change_domain", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChangeProductionInstanceDomainError> = serde_json::from_str(&local_var_content).ok();
