...
------------- | ------------- | ------------- | ------------- | -------------
**change_production_instance_domain_request** | Option<[**ChangeProductionInstanceDomainRequest**](ChangeProductionInstanceDomainRequest.md)> |  |  |
...
> models::UpdateInstanceAuthConfig200Response update_instance_auth_config(update_instance_auth_config_request)
...
[**models::UpdateInstanceAuthConfig200Response**](UpdateInstanceAuthConfig_200_response.md)
