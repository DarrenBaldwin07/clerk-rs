...
**attribute_mapping** | Option<**std::collections::HashMap<String, String>**> | Attribute-to-directory-path entries to merge into the directory's attribute mapping. Set a key to `null` to remove it from the mapping. | [optional]
