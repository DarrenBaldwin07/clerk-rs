...
> models::Domain add_domain(add_domain_request)
Add a domain
...
> models::DeletedObject delete_domain(domain_id)
...
> models::Domain update_domain(domain_id, update_domain_request)
Update a domain
