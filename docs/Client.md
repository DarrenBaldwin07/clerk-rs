...
------------ | ------------- | ------------- | -------------
**object** | **Object** | String representing the object's type. Objects of the same type share the same value.  (enum: client) |
...
**last_authentication_strategy** | Option<**String**> | The authentication strategy that was last used to authenticate the user on this client.  |
