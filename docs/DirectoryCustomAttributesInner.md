# DirectoryCustomAttributesInner
...
**scim_path** | Option<**String**> | The legacy name for `directory_path`. Carries the same value. | [optional]
**directory_path** | Option<**String**> | GJSON path to extract the attribute value from directory sync user resources | [optional]
